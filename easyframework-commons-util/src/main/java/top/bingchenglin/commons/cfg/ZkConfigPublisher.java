...
public class ZkConfigPublisher {
    public static String CONF_DIR = "D:\\zookeeper\\conf";
    ...
    public static int ZK_TIMEOUT = 50000;
    ...
    private static final void loadProperties() {
        ...
        CONF_DIR = props.getProperty("CONF_DIR", CONF_DIR);
        ZK_CONFIG_ROOTNODE = props.getProperty("ZK_CONFIG_ROOTNODE", ZK_CONFIG_ROOTNODE);
        ZK_CONF_ENCODING = props.getProperty("ZK_CONF_ENCODING", ZK_CONF_ENCODING);
        ZK_TIMEOUT = Integer.parseInt(props.getProperty("ZK_TIMEOUT", ZK_TIMEOUT + ""));
